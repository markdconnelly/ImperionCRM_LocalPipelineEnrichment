@{
    ...
    ModuleVersion     = '0.16.0' # x-release-please-version
    ...
    FunctionsToExport = @(
        ...
        'Invoke-ImperionThreadsRequest',
        'Invoke-ImperionDattoRmmRequest',
        'Invoke-ImperionPax8Request',
        ...
        'Get-ImperionMetaMention',
        'Get-ImperionMetaConversation',
        'Get-ImperionInstagramMedia',
        'Get-ImperionInstagramComment',
        'Get-ImperionInstagramMessage',
        'Get-ImperionMetaInsight',
        'Get-ImperionMetaPostInsight',
        'Get-ImperionMetaAdInsight',
        'Get-ImperionMetaLeadForm',
        'Get-ImperionMetaLead',
        'Get-ImperionThreadsPost',
        'Get-ImperionThreadsReply',
        'Get-ImperionThreadsMention',
        'Get-ImperionThreadsInsight',
        'Get-ImperionSecurityIncident',
        'Get-ImperionDattoRmmDevice',
        'Get-ImperionPax8Company',
        'Get-ImperionPax8Subscription',
        'Get-ImperionPax8License',
        'Get-ImperionPax8Order',
        ...
        'Set-ImperionMetaMentionToBronze',
        'Set-ImperionMetaMessageToBronze',
        'Set-ImperionInstagramMediaToBronze',
        'Set-ImperionInstagramCommentToBronze',
        'Set-ImperionInstagramMessageToBronze',
        'Set-ImperionMetaInsightToBronze',
        'Set-ImperionMetaLeadFormToBronze',
        'Set-ImperionMetaLeadToBronze',
        'Set-ImperionThreadsPostToBronze',
        'Set-ImperionThreadsReplyToBronze',
        'Set-ImperionThreadsMentionToBronze',
        'Set-ImperionThreadsInsightToBronze',
        'Set-ImperionSecurityIncidentToBronze',
        'Set-ImperionDattoRmmDeviceToBronze',
        'Set-ImperionPax8CompanyToBronze',
        'Set-ImperionPax8SubscriptionToBronze',
        'Set-ImperionPax8LicenseToBronze',
        'Set-ImperionPax8OrderToBronze',
