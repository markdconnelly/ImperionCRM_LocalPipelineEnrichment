...
| [ADR-0014](ADR-0014-quickbooks-online-payment-fact.md) | QuickBooks Online vendor bill-payments as the authoritative payment fact | Proposed | 2026-06-13 | A scheduled on-prem collector bulk-pulls QBO BillPayment rows into bronze `qbo_bill_payments` (read-only, authoritative for the payment fact alone); deploy-ahead/gated on the QBO app registration + migration. |
